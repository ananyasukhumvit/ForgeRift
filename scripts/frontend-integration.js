 ...
 * This file demonstrates how to integrate Forgerift with a web frontend
 */

// For React/Vue/Angular applications
export class ForgeriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ForgeriftClient(provider, contractAddress);
